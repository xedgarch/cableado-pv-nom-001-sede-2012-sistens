...
import pandas as pd
from PIL import Image #libreria para agregar imagenes (No es necesario instalar)

#Agregando imagenes
logo = Image.open("logo_sistens_png.png")
logo_full = Image.open("sistens_logo_completo.png")

# Configuración inicial
#Encabezado de pagina en la pestaña
st.set_page_config(page_title="Cálculo de Calibre de Conductores PV", layout="wide",page_icon=logo)
st.title("Cálculo de Calibre de Conductores PV según Nom-sede-2012")

# Descripción y enlaces
st.markdown(
    """
    ### Bienvenido a la herramienta de cálculo de calibre de conductores
    Esta aplicación dimensiona los conductores para sistemas fotovoltaicos según la NOM-001-SEDE-2012, 
    incluyendo el cálculo del conductor de puesta a tierra. Es una herramienta de apoyo para estudiantes, 
    técnicos y profesionales interesados en energía solar.

    **Nota:**
    - Esta herramienta aún está en desarrollo.
    - No sustituye la supervisión de un profesional calificado.
    - Tus comentarios y sugerencias son bienvenidos para mejorar esta aplicación.

    Si te interesa más contenido como este, sigenos en nuestras redes sociales:
    
    **Youtube**:[SistEnS PV](https://www.youtube.com/@SistEnS-PV).
    
    **Facebook**:[SistEnS](https://www.facebook.com/profile.php?id=100087394063239).
    """
)
...
#Para activar las tablas borrar los siguientes dos renglones y descomentar el tercer siguiente renglon
tablasreferencias = 1
if tablasreferencias == 0:
...
st.markdown(
    """
    ---
    **Aviso:** Esta herramienta cuenta con derechos reservados y está destinada exclusivamente para uso en sitios validados por SistEnS. El uso indebido o no autorizado está prohibido.
    """
)
